...
export class ElexArchival implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement): void
	{
		...
		this.api.hideFormOnLoad("No",context);
	    ...
	    document.getElementById("btnReset")?.addEventListener("click",Event=> this.api.getFetchNumber(context));
		document.getElementById("fetchxml")?.addEventListener("change", Event => this.api.validateFetchXml(context));
